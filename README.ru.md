...
- **Двойной Shift / двойной Option** — нажмите `⇧⇧` или `⌥⌥` (модификатор дважды быстро) для конвертации, или настройте свою комбинацию
...
- **8 раскладок** — английская, русская, украинская, польская, немецкая, французская, испанская
...
3. Нажимаете ⇧⇧ (двойной Shift) или ⌥⌥ (двойной Option)
...
3. **Нажимаете** `⇧⇧` (двойной Shift) или `⌥⌥` (двойной Option) — Умная конвертация сама выделяет и конвертирует
...
| **Hotkey** | Выбор двойного Shift ⇧⇧, двойного Option ⌥⌥ или запись своей комбинации |
...
| ABC | `en` | QWERTY |
| Русская | `ru` | ЙЦУКЕН |
| Украинская | `uk` | ЙЦУКЕН (Ukrainian) |
| Польская | `pl` | QWERTY (Polish Pro) |
| Польская – QWERTZ | `pl` | QWERTZ (Polish) |
| Немецкая | `de` | QWERTZ |
