...
enum Strings_ua {
    ...
    static let strings: [String: String] = [
        ...
        "menu.previewRecovery":          "Передперегляд відновлення...",
        ...
        "general.thoughtRecovery":         "Відновлення тексту",
        "general.thoughtRecoveryEnabled":  "Відновлювати змішані речення",
        "general.thoughtRecoveryPreview":  "Показувати передперегляд перед застосуванням",
        "general.thoughtRecoveryHint":     "Виправляє лише слова, зламані розкладкою, у реченнях зі змішаними мовами — код, посилання та навмисні англійські слова не змінюються. Вибір «залишити як є» у передперегляді навчає особистий словник.",
        "general.recoveryStats":           "Відновлень:",
        "general.recoveryRevertRate":      "скасовано",
        "general.mode":                  "Режим:",
        ...
        "recovery.title":                "Відновлення тексту",
        "recovery.subtitle":             "Зміняться лише виділені слова.",
        "recovery.nothingToChange":      "У цьому рядку нічого відновлювати — він уже читається як мова.",
        "recovery.original":             "Набрано",
        "recovery.reconstructed":        "Відновлено",
        "recovery.alternatives":         "Інші варіанти",
        "recovery.changedSpans":         "Змінені слова",
        "recovery.confidence":           "Впевненість: %@",
        "recovery.apply":                "Застосувати",
        "recovery.copy":                 "Копіювати",
        "recovery.revert":               "Залишити як є",
        "recovery.revertHint":           "Варіант «залишити як є» також запам'ятовує ці слова — їх більше не виправлятимуть.",
        "recovery.kind.wrongLayout":     "розкладка",
        "recovery.kind.intentionalForeign": "інше слово",
        "recovery.kind.code":            "код",
        "recovery.kind.url":             "посилання",
        "recovery.kind.properName":      "ім'я",
        "recovery.kind.ambiguous":       "неясно",
        "recovery.kind.correct":         "правильно",
        "recovery.kind.separator":       "розділювач",
