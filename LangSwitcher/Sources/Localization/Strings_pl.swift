...
enum Strings_pl {
    ...
    static let strings: [String: String] = [
        ...
        "menu.previewRecovery":          "Podgląd odzyskiwania...",
        ...
        "general.thoughtRecovery":         "Odzyskiwanie tekstu",
        "general.thoughtRecoveryEnabled":  "Odzyskuj zdania mieszane językowo",
        "general.thoughtRecoveryPreview":  "Pokaż podgląd przed zastosowaniem",
        "general.thoughtRecoveryHint":     "Poprawia tylko słowa zepsute przez złą klawiaturę w zdaniach mieszanych — kod, linki i celowe angielskie słowa pozostają bez zmian. Wybranie «zostaw oryginał» w podglądzie uczy słownik osobisty.",
        "general.recoveryStats":           "Odzyskania:",
        "general.recoveryRevertRate":      "cofnięte",
        "general.mode":                  "Tryb:",
        ...
        "recovery.title":                "Odzyskiwanie tekstu",
        "recovery.subtitle":             "Zmienią się tylko podświetlone słowa.",
        "recovery.nothingToChange":      "W tym wierszu nie ma nic do odzyskania — czyta się jak język.",
        "recovery.original":             "Wpisane",
        "recovery.reconstructed":        "Odzyskane",
        "recovery.alternatives":         "Inne odczyty",
        "recovery.changedSpans":         "Zmienione słowa",
        "recovery.confidence":           "Pewność: %@",
        "recovery.apply":                "Zastosuj",
        "recovery.copy":                 "Kopiuj",
        "recovery.revert":               "Zostaw oryginał",
        "recovery.revertHint":           "Opcja «zostaw oryginał» zapamiętuje też te słowa — nie będą już poprawiane.",
        "recovery.kind.wrongLayout":     "zła klawiatura",
        "recovery.kind.intentionalForeign": "obce słowo",
        "recovery.kind.code":            "kod",
        "recovery.kind.url":             "link",
        "recovery.kind.properName":      "nazwa",
        "recovery.kind.ambiguous":       "niejasne",
        "recovery.kind.correct":         "poprawne",
